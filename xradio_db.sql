...
CREATE TABLE `configs` (
  `id` int(11) NOT NULL,
  `is_full_bg` int(1) NOT NULL,
  `ui_top_chart` int(1) NOT NULL,
  `ui_genre` int(1) NOT NULL,
  `ui_favorite` int(1) NOT NULL,
  `ui_themes` int(1) NOT NULL,
  `ui_detail_genre` int(1) NOT NULL,
  `ui_player` int(1) NOT NULL,
  `ui_search` int(1) NOT NULL,
...
CREATE TABLE `themes` (
  ...
  `name` varchar(255) CHARACTER SET utf8 NOT NULL,
  `img` varchar(255) CHARACTER SET utf8 NOT NULL,
  `grad_start_color` varchar(255) CHARACTER SET utf8 NOT NULL,
  `grad_end_color` varchar(255) CHARACTER SET utf8 NOT NULL,
  `grad_orientation` int(11) NOT NULL,
  `is_single_theme` int(1) NOT NULL,
  `isActive` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, `admin`, `user_90008_img-thing.jpg`, `hola123`, `bl911vn@gmail.com`, 1);
